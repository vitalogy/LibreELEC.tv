...
PKG_LONGDESC="Pygame-${PKG_VERSION} is a Python wrapper module for the SDL multimedia library"
PKG_AUTORECONF="no"
...
#  $SED "s:-Wl,-rpath,[^ ]* :-Wl,-rpath,../SDL :g" $ROOT/$PKG_BUILD/Setup

  # disable some modules
  $SED "s:^scrap:#scrap:" $ROOT/$PKG_BUILD/Setup
  $SED "s:^_camera:#_camera:" $ROOT/$PKG_BUILD/Setup
}
...
post_makeinstall_target() {
  EXCLUDE="docs examples gp2x tests pygame_icon* *.html _camera* mac*"
